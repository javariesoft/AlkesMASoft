 ...
 * @author TI-PNP
 */
public class DialogPembelianInternal extends javax.swing.JInternalFrame {
    ...
    public DialogPembelianInternal() {
        initComponents();
        try {
    ...
    public DialogPembelianInternal(int id, double tot, int pil) {
        initComponents();
        //Connection c = null;
        try {
            c = koneksi.getKoneksiJ();
...
//        }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(javariesoft.JavarieSoftApp.class).getContext().getResourceMap(DialogPembelianInternal.class);
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(470, 10, 110, 15);
        ...
        cbostatusBeli.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                cbostatusBeliItemStateChanged(evt);
            }
        });
        cbostatusBeli.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                cbostatusBeliKeyPressed(evt);
            }
        });
        ...
        jPanel1.add(jLabel9);
        jLabel9.setBounds(470, 60, 90, 15);
        ...
        txtkodeFaktur.setEditable(false);
        ...
        jPanel4.add(jLabel7);
        jLabel7.setBounds(680, 0, 120, 20);
        ...
        jumlahBarang.setBounds(800, 20, 90, 22);
        ...
        jLabel23.setBounds(890, 0, 120, 20);
        ...
        hargaBarang.setBounds(680, 20, 120, 22);
        ...
        txtDiskon.setBounds(890, 20, 70, 22);
        ...
        jLabel27.setBounds(580, 0, 100, 20);
        ...
        cboSatuan.setBounds(580, 20, 100, 20);
        ...
        jLabel31.setBounds(800, 0, 90, 20);
        ...
        btnSimpanHasil.setBounds(680, 6, 150, 50);
    ...
    private void jTable2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable2KeyPressed
        ...
        if (evt.getKeyCode() == 10) {
            ...
            try {
                ...
                double hk = Fungsi.getHargaBeliAkhir(c, kodeSupplier.getText(), b.getKODEBARANG(), cboSatuan.getSelectedItem().toString());
//                hargaBarang.setText("" + hk);
                hargaBarang.setValue(hk);
                double disItemBeli = Fungsi.getDiskonItemBeliAkhir(c, kodeSupplier.getText(), b.getKODEBARANG(), cboSatuan.getSelectedItem().toString());
//                txtDiskon.setText("" + disItemBeli);
                txtDiskon.setValue(disItemBeli);
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        ...
        try {
            //        c = koneksi.getKoneksiJ();
//            System.out.print(hargaBarang.getValue());
            if (barangDao.cekKodeBarang(c, kodeBarang.getText()) != true) {
                ...
                kosongBarang();
                kodeBarang.requestFocus();
            } else if ((jumlahBarang.getText().trim().length() == 0) || (Integer.parseInt(jumlahBarang.getText()) <= 0)) {
                JOptionPane.showMessageDialog(null, "Jumlah Barang tidak Valid");
                jumlahBarang.requestFocus();
                //} else if ((hargaBarang.getValue().toString().equals("0")) || (hargaBarang.getText().trim().length() == 0)) {
            } else if ((Double.parseDouble(hargaBarang.getValue().toString()) < 0) || (hargaBarang.getValue().toString().equals("0.0")) || (hargaBarang.getText().trim().length() == 0) || (hargaBarang.getText().equals("0.00"))) {
            ...
            //        }
                ...
                double ppn, tppn1, tot, tdiskon1, tdiskonpersen = 0;
                barang b = new barangDao().getDetails(c, kodeBarang.getText());
                tot = Integer.parseInt(jumlahBarang.getText()) * Double.parseDouble(hargaBarang.getValue().toString());

                //double tppn1 = (Double.parseDouble(txtPPN.getValue().toString()) / 100) * (tot - tdiskon1); Lama
                if (cbBonus.isSelected()) {//checkbox has been selected
                    tdiskon1 = 0;
                    tdiskonpersen = 0;
                    tppn1 = 0;
                } else {
                    tdiskon1 = getDiskon(Integer.parseInt(jumlahBarang.getText()), Double.parseDouble(hargaBarang.getValue().toString()));
                    tdiskonpersen = getDiskonPersen(Integer.parseInt(jumlahBarang.getText()), Double.parseDouble(hargaBarang.getValue().toString()));
                    tppn1 = getPPN(tot - tdiskon1);
                }
                ...
                if (jTabbedPane2.getSelectedIndex() == 0) {
                    if (!pembelianDao.cekFaktur(c, txtkodeFaktur.getText())) {
                        if (kodeSupplier.getText().equals("")) {
                            ...
                            cbostatusBeli.requestFocus();
                        } else if (!KontrolTanggalDao.cekHarian(c, txtTglMasuk.getText())) {
...
//                }
    ...
    private void cbostatusBeliKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cbostatusBeliKeyPressed
        // TODO add your handling code here:
        if (evt.getKeyCode() == 10) {
            kodeSupplier.requestFocus();
        }
    }//GEN-LAST:event_cbostatusBeliKeyPressed

    private void cbostatusBeliItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbostatusBeliItemStateChanged
        // TODO add your handling code here:
        try {
            // TODO add your handling code here:
            //Connection c = koneksi.getKoneksiJ();
    ...
    }//GEN-LAST:event_cbostatusBeliItemStateChanged
    ...
    private void cbBonusItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbBonusItemStateChanged
        ...
        try {
            if (evt.getStateChange() == ItemEvent.SELECTED) {//checkbox has been selected
                if ((Double.parseDouble(hargaBarang.getValue().toString()) < 0) || (hargaBarang.getValue().toString().equals("0.0")) || (hargaBarang.getText().trim().length() == 0) || (hargaBarang.getText().equals("0.00"))) {
    ...
    private void cboSatuanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboSatuanActionPerformed
        // TODO add your handling code here:
          try {
            ...
            Logger.getLogger(DialogPembelianInternal.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void hasilAkhir(Connection c) throws SQLException {
        ...
        System.out.println("Harga    :" + hargaBarang.getValue());
    }
    ...
    private void reloadData(Connection c) {
        ...
        try {
            ...
            while (r1.next()) {
                if (r1.getString("BONUS").trim().equals("Bonus")) {
                    bonus += (r1.getDouble("JUMLAH") * r1.getDouble("HARGA"));
                } else {
...
//                    }
    ...
    void insertRinciJurnal(Connection c) throws SQLException, ClassNotFoundException {
        ...
        if (cbostatusBeli.getSelectedIndex() == 0) {
            ...
            if (bonus != 0) {
                s.execute("insert into RINCIJURNAL values(" + IDJurnal + ",'" + settingDao.getAkun(c, "PERSEDIAANBONUS") + "'," + bonus + ",0,2,'" + settingDao.getDetails(c, "PERSEDIAANBONUS").getKODE() + "')");
                s.execute("insert into RINCIJURNAL values(" + IDJurnal + ",'" + settingDao.getAkun(c, "BONUS") + "',0," + bonus + ",2,'" + settingDao.getDetails(c, "BONUS").getKODE() + "')");
            }
            if (tppn > 0) {
...
////                stokDao.insertIntoSTOK(c, st);
    ...
    void setRetur(Connection c) throws SQLException {
        ...
        txtkodeRetur.setText(returbeliDao.setReturBeli(c));
    }
