...
/*
 * FLapBarangPembelian.java
 *
 * Created on Nov 24, 2019, 10:18:20 PM
 */
package javariesoft;
 ...
 * @author eigher
 */
public class FLapBarangPembelian extends javax.swing.JInternalFrame {
    ...
    public FLapBarangPembelian() {
        ...
        try {
            ...
            Logger.getLogger(FLapBarangPembelian.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(javariesoft.JavarieSoftApp.class).getContext().getResourceMap(FLapBarangPembelian.class);
...
//            }else{
                URL url = new URL(global.REPORT + "/BarangMerkHargaBeli.jasper");
                InputStream in = url.openStream();
                jasperPrint = JasperFillManager.fillReport(in, parameter, c);
                JasperViewer.viewReport(jasperPrint, false);
//            }
