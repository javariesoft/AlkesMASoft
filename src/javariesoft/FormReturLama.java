 ...
 * @author TI-PNP
 */
public class FormReturLama extends javax.swing.JInternalFrame implements ListSelectionListener {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(javariesoft.JavarieSoftApp.class).getContext().getResourceMap(FormReturLama.class);
        ...
        cboKriteria.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Kode Retur", "Tanggal", "Pelanggan", "Kas" }));
        ...
        jScrollPane1.setBounds(10, 60, 1050, 270);
    ...
    private void btnFilterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFilterActionPerformed
        try {
            ...
            Logger.getLogger(FormReturLama.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnDeleteValidasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteValidasiActionPerformed
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(FormReturLama.class.getName()).log(Level.SEVERE, null, ex1);
            }
        } finally {
            if (c != null) {
                try {
                ...
                if (cboRetur.getSelectedIndex() == 1) {
                    ...
                    if (rb.getSTATUS() == 1) {
                        ...
                        if (totalhutang == ttotalbayar) {
                            hutang h = hutangDao.getDetailsBeli(c, idbeli);
                            h.setSTATUS("0");
                            hutangDao.updateHUTANG(c, h.getID(), h);
                        }
                        reloaddata(c, cboRetur.getSelectedIndex());
                    ...
                    if (rj.getSTATUS() == 1) {
                        ...
                        if (ttotalbayar == totalpiutang) {
                            piutang p = piutangDao.getDetailPiutangperJual(c, idjual);
                            p.setSTATUS("0");
...
//                    insertRinciJurnalReturJual(c, rj);
    ...
    void prosesUpdateLog(String aksilog, String jretur) {
        ...
        try {
            ...
            if (aksilog.equals("Insert")) {
                ketlog = "Insert Data Penjualan " + tabelData.getValueAt(tabelData.getSelectedRow(), 0).toString();
            } else if (aksilog.equals("Update")) {
                ketlog = "Update Data Penjualan " + tabelData.getValueAt(tabelData.getSelectedRow(), 0).toString();
    ...
    void insertRinciJurnalReturBeli(Connection c, returbeli rb, double totalpersediaan) throws SQLException, ClassNotFoundException {
        ...
        if (totalhutang >= ttotalbayar) {
            ...
            s.execute("insert into RINCIJURNAL values(" + IDJurnal + ",'" + settingDao.getAkun(c, "KAS") + "'," + ttotalbayar + ",0,4,'RETURBELI')");
            JOptionPane.showMessageDialog(panelCool1, "Retur Ini Menambah Kas Anda");
        }
//        else {
...
//                    ResultSet rspiutangtot = spiutangtot.executeQuery(sqlpiutangtot);
                    ...
                    double total_piutang = piutangDao.getJumlahPiutangPelanggan(c, rj.getKODEPELANGGAN());
                    sisakaspiutang = ttotalbayar - total_piutang;
                    if (sisakaspiutang < 0) {
