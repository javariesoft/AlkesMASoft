...
public class ClassPrintLama1 {
    ...
    public static void main(String[] args) {
        //Connection c;       
        ClassPrintLama1 cs = new ClassPrintLama1();
        try {
    ...
    public void cetakfaktur(String nfak) {
        ...
        ClassPrintLama1 cp = new ClassPrintLama1();
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(ClassPrintLama1.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static Map<String, Object> cetakfakturMap(Connection con, String nfak) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                line.put("jumlah", df.format(rs.getDouble(15)));
                tables.add(line);
            }
            while (true) {
                if (no % 7 != 0) {
            ...
            bayar = (rs1.getString(37).equals("0") ? total +rs1.getDouble(44) +rs1.getDouble(45)  : (rs1.getDouble(8)!=0 ? rs1.getDouble(8):0));
//            totalbersih = (total - rs1.getDouble(9) - rs1.getDouble(8)) + rs1.getDouble(44);
            totalbersih = (rs1.getString(37).equals("0") ? 0 : (rs1.getDouble(8)!=0 ? (total + rs1.getDouble(44) + rs1.getDouble(45) - rs1.getDouble(8)) : total + rs1.getDouble(44) + rs1.getDouble(45) ));
            double terbilang = 0;
            if (totalbersih == 0) {
                terbilang = bayar;
            } else {
