 ...
 * @author UserXP
 */
public class ClassPrintDOLama {
        Connection c;
    public static void main(String[] args) {
        //Connection c;       
        ClassPrintDOLama cs = new ClassPrintDOLama();
        try { 
    ...
    public void cetakfaktur(String nfak){
        ...
        ClassPrintDOLama cp = new ClassPrintDOLama();
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(ClassPrintDOLama.class.getName()).log(Level.SEVERE, null, ex);
            }
