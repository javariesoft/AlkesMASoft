...
public class ClassPrintLama2 {
    ...
    public static void main(String[] args) {
        //Connection c;       
        ClassPrintLama2 cs = new ClassPrintLama2();
        try {
    ...
    public void cetakfaktur(String nfak) {
        ...
        ClassPrintLama2 cp = new ClassPrintLama2();
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(ClassPrintLama2.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static Map<String, Object> cetakfakturMap(Connection con, String nfak) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                line.put("jumlah", df1.format(rs.getDouble(33)));
