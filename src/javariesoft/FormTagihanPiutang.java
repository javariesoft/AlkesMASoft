 ...
 * @author erwadi
 */
public class FormTagihanPiutang extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(javariesoft.JavarieSoftApp.class).getContext().getResourceMap(FormTagihanPiutang.class);
        ...
        btnLoadJual.setBounds(120, 10, 100, 25);
...
private void btnFilterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFilterActionPerformed
    ...
    try {
        ...
        Logger.getLogger(FormTagihanPiutang.class.getName()).log(Level.SEVERE, null, ex);
    }
//    finally {
//        if (c != null) {
//            try {
