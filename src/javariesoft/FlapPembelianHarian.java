...
public class FlapPembelianHarian extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setBounds(285, 40, 30, 15);
        ...
        btnKeluar.setBounds(370, 140, 150, 40);
        ...
        btnPreview.setBounds(62, 140, 150, 40);
        ...
        cbOpsiFaktur.setBounds(150, 100, 150, 20);

        jLabel2.setFont(resourceMap.getFont("jLabel2.font")); // NOI18N
        jLabel2.setText(resourceMap.getString("jLabel2.text")); // NOI18N
        jLabel2.setName("jLabel2"); // NOI18N
        getContentPane().add(jLabel2);
        jLabel2.setBounds(20, 70, 110, 20);
        ...
        BtnClear.setBounds(216, 140, 150, 40);
    ...
    private void btnPreviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPreviewActionPerformed
        ...
        try {
            ...
            if (OptTanggal.isSelected() && OptSupplier.isSelected() && OptOpsiFaktur.isSelected()) {
                if (cbOpsiFaktur.getSelectedIndex() == 0) {
                    ...
                    URL url = new URL(global.REPORT + "/PembelianHarianPTGLSupplierPajak.jasper");
                    ...
                    parameter.put("tgl2", tgl2.getText());
                    parameter.put("PSupplier", txtkodesupplier.getText());
                    URL url = new URL(global.REPORT + "/PembelianHarianPTGLSupplierNonPajak.jasper");
                    InputStream in = url.openStream();
                    jasperPrint = JasperFillManager.fillReport(in, parameter, c);
                    JasperViewer.viewReport(jasperPrint, false);
                }
                ...
                if (cbOpsiFaktur.getSelectedIndex() == 0) {
                    parameter.put("tgl1", tgl1.getText());
                    parameter.put("tgl2", tgl2.getText());
                    URL url = new URL(global.REPORT + "/PembelianHarianPTGLPajak.jasper");
                    InputStream in = url.openStream();
                    jasperPrint = JasperFillManager.fillReport(in, parameter, c);
                    JasperViewer.viewReport(jasperPrint, false);
                } else {
                    parameter.put("tgl1", tgl1.getText());
                    parameter.put("tgl2", tgl2.getText());
                    URL url = new URL(global.REPORT + "/PembelianHarianPTGLNonPajak.jasper");
                    InputStream in = url.openStream();
                    jasperPrint = JasperFillManager.fillReport(in, parameter, c);
                    JasperViewer.viewReport(jasperPrint, false);
                }
                ...
                parameter.put("tgl2", tgl2.getText());
                parameter.put("PSupplier", txtkodesupplier.getText());
                URL url = new URL(global.REPORT + "/PembelianHarianPTGLSupplier.jasper");
                InputStream in = url.openStream();
                jasperPrint = JasperFillManager.fillReport(in, parameter, c);
                JasperViewer.viewReport(jasperPrint, false);
                ...
                parameter.put("tgl1", tgl1.getText());
                parameter.put("tgl2", tgl2.getText());
                URL url = new URL(global.REPORT + "/PembelianHarianPTGL.jasper");
                InputStream in = url.openStream();
                jasperPrint = JasperFillManager.fillReport(in, parameter, c);
                JasperViewer.viewReport(jasperPrint, false);
            }
