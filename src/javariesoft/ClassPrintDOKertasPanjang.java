 ...
 * @author UserXP
 */
public class ClassPrintDOKertasPanjang {
    ...
    public static void main(String[] args) {
        //Connection c;       
        ClassPrintDOKertasPanjang cs = new ClassPrintDOKertasPanjang();
        try {
    ...
    public void cetakfaktur(String nfak) {
        ...
        ClassPrintDOKertasPanjang cp = new ClassPrintDOKertasPanjang();
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(ClassPrintDOKertasPanjang.class.getName()).log(Level.SEVERE, null, ex);
            }
