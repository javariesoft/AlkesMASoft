 ...
 * @author UserXP
 */
public class ClassPrintLama {
        Connection c;
    public static void main(String[] args) {
        //Connection c;       
        ClassPrintLama cs = new ClassPrintLama();
        try { 
            koneksi.createPoolKoneksi();      
            cs.cetakfaktur("15.000084");
    ...
    public void cetakfaktur(String nfak){
        ...
        ClassPrintLama cp = new ClassPrintLama();
        ...
        try {
            ...
            try {
                ...
                p.append(data2);
                p.append(data3);                                                                                             //       //              //
                p.append("PT.MIRANTI ADILHA                                                              Kepada : "+ cp.cetak(pel, 45, 0) +"\r\n");
                //p.append("No Izin PBF : HK.07.01/V/302/14                                                             "+ cp.cetak(Altpel, 50, 0) +"\r\n");
              if(rs1.getString(18).length()>=45){
                p.append("No Izin PBF : HK.07.01/V/302/14                                                          "+ cp.cetak(Altpel, 50, 0) +"\r\n"); 
                p.append("No Izin PAK : HK.07.ALKES/IV/372/AK.2/2014                                               "+ cp.cetak(Altpel1, 50, 0) +"\r\n"); 
                p.append("NPWP        : 31.640.740.2.201.000                                                                No Faktur   : "+cp.cetak(rs1.getString(2), 10, 1)+"\r\n");
                p.append("Jl. Gajah Mada No. 03 Gunung Pangilun-Padang                                                      Tanggal     : "+cp.cetak(rs1.getString(3), 10, 1) +"\r\n");
                p.append("Email : ptmirantiadilha@gmail.com                                                                 Jatuh Tempo : "+cp.cetak(rs1.getString(6), 10, 1) +" \r\n"); 
              }else{
                p.append("No Izin PBF : HK.07.01/V/302/14                                                          "+ cp.cetak(Altpel, 50, 0) +"\r\n"); 
                p.append("No Izin PAK : HK.07.ALKES/IV/372/AK.2/2014                                                        No Faktur   : "+cp.cetak(rs1.getString(2), 10, 1)+"\r\n");
                p.append("NPWP        : 31.640.740.2.201.000                                                                Tanggal     : "+cp.cetak(rs1.getString(3), 10, 1) +"\r\n");
                p.append("Jl. Gajah Mada No. 03 Gunung Pangilun-Padang                                                      Jatuh Tempo : "+cp.cetak(rs1.getString(6), 10, 1) +" \r\n");
                ...
                Logger.getLogger(ClassPrintLama.class.getName()).log(Level.SEVERE, null, ex);
            }
