 ...
 * @author eigher
 */
public class FlapBarangDOMerk extends javax.swing.JInternalFrame {
     ...
     */
    public FlapBarangDOMerk() {
        initComponents();
        try {
            c = koneksi.getKoneksiJ();
        } catch (Exception ex) {
            Logger.getLogger(FlapBarangDOMerk.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(javariesoft.JavarieSoftApp.class).getContext().getResourceMap(FlapBarangDOMerk.class);
    ...
    private void btnPreviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPreviewActionPerformed
        ...
        try {
            ...
            URL url = new URL(global.REPORT + "/BarangDO.jasper");
