 ...
 * @author erwadi
 */
public class FLapDetailDO extends javax.swing.JInternalFrame {
    ...
    public FLapDetailDO() {
        ...
        try {
            ...
            Logger.getLogger(FLapDetailDO.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(javariesoft.JavarieSoftApp.class).getContext().getResourceMap(FLapDetailDO.class);
        ...
        OptPelanggan.setBounds(330, 7, 100, 23);
        ...
        OptStatus.setFont(resourceMap.getFont("jCheckBox2.font")); // NOI18N
...
// TODO add your handling code here:
    ...
    try {
        ...
        if (OptTanggal.isSelected() && OptStatus.isSelected() && OptPelanggan.isSelected()) {
            ...
            URL url = new URL(global.REPORT + "/LapDetailDOPTglStatusPelanggan.jasper");
            ...
            parameter.put("tgl2", tgl2.getText());
            parameter.put("Pstatus", kode);
            URL url = new URL(global.REPORT + "/LapDetailDOPTglStatus.jasper");
            InputStream in = url.openStream();
            jasperPrint = JasperFillManager.fillReport(in, parameter, c);
            JasperViewer.viewReport(jasperPrint, false);
            ...
            parameter.put("tgl2", tgl2.getText());
            parameter.put("PPelanggan", txtkodepelanggan.getText());
            URL url = new URL(global.REPORT + "/LapDetailDOPTglPelanggan.jasper");
            InputStream in = url.openStream();
            jasperPrint = JasperFillManager.fillReport(in, parameter, c);
            JasperViewer.viewReport(jasperPrint, false);
            ...
            parameter.put("tgl1", tgl1.getText());
            parameter.put("tgl2", tgl2.getText());
            URL url = new URL(global.REPORT + "/LapDetailDOPTglAllRecord.jasper");
            InputStream in = url.openStream();
            jasperPrint = JasperFillManager.fillReport(in, parameter, c);
            JasperViewer.viewReport(jasperPrint, false);
        }
