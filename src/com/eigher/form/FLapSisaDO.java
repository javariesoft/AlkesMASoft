 ...
 * @author erwadi
 */
public class FLapSisaDO extends javax.swing.JInternalFrame {
    ...
    public FLapSisaDO() {
        ...
        try {
            ...
            Logger.getLogger(FLapSisaDO.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(javariesoft.JavarieSoftApp.class).getContext().getResourceMap(FLapSisaDO.class);
        ...
        OptPelanggan.setBounds(240, 7, 100, 23);
        ...
        jScrollPane1.setBounds(70, 90, 460, 120);
        ...
        txtnamapelanggan.setBounds(100, 70, 340, 22);
        ...
        txtkodepelanggan.setBounds(440, 70, 70, 22);
        ...
        OptAwal.setBounds(100, 40, 90, 23);

        setBounds(0, 0, 551, 252);
...
// TODO add your handling code here:
    ...
    try {
        ...
        if (OptTanggal.isSelected() && OptPelanggan.isSelected()) {
            parameter.put("tgl1", tgl1.getText());
            parameter.put("tgl2", tgl2.getText());
            parameter.put("PKodePelanggan", txtkodepelanggan.getText());
            URL url = new URL(global.REPORT + "/LapSisaDOPelangganPTglPelanggan.jasper");
            ...
            parameter.put("tgl1", tgl1.getText());
            parameter.put("tgl2", tgl2.getText());
            URL url = new URL(global.REPORT + "/LapSisaDOPelangganAllRecord.jasper");
            InputStream in = url.openStream();
            jasperPrint = JasperFillManager.fillReport(in, parameter, c);
            JasperViewer.viewReport(jasperPrint, false);
        } 
