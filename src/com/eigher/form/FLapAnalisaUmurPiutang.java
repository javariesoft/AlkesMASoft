 ...
 * @author eigher
 */
public class FLapAnalisaUmurPiutang extends javax.swing.JInternalFrame {
    ...
    public FLapAnalisaUmurPiutang() {
        ...
        try {
            ...
            Logger.getLogger(FLapAnalisaUmurPiutang.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(javariesoft.JavarieSoftApp.class).getContext().getResourceMap(FLapAnalisaUmurPiutang.class);
    ...
    private void btnPreviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPreviewActionPerformed
        ...
        try {
            ...
            if (OptTanggal.isSelected() && OptStatus.isSelected() && OptPelanggan.isSelected()) {
                ...
                URL url = new URL(global.REPORT + "/LapAnalisaPiutangPTglStatusPelanggan.jasper");
