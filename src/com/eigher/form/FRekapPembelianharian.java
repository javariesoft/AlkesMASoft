        ...
        try {
            ...
            if (OptTanggal.isSelected() && OptOpsiFaktur.isSelected() && OptSupplier.isSelected()) {
                if (cbOpsiFaktur.getSelectedIndex() == 0) {
                    ...
                    URL url = new URL(global.REPORT + "/RekapBeliHarianPTGLPajakSupplier.jasper");
                    ...
                    parameter.put("Ptgl2", tgl2.getText());
                    parameter.put("Psupplier", txtkodesupplier.getText());
                    URL url = new URL(global.REPORT + "/RekapBeliHarianPTGLNonPajakSupplier.jasper");
                    InputStream in = url.openStream();
                    jasperPrint = JasperFillManager.fillReport(in, parameter, c);
                    JasperViewer.viewReport(jasperPrint, false);
                }
                ...
                if (cbOpsiFaktur.getSelectedIndex() == 0) {
                    parameter.put("Ptgl1", tgl1.getText());
                    parameter.put("Ptgl2", tgl2.getText());
                    URL url = new URL(global.REPORT + "/RekapBeliHarianPTGLPajak.jasper");
                    InputStream in = url.openStream();
                    jasperPrint = JasperFillManager.fillReport(in, parameter, c);
                    JasperViewer.viewReport(jasperPrint, false);
                } else {
                    parameter.put("Ptgl1", tgl1.getText());
                    parameter.put("Ptgl2", tgl2.getText());
                    URL url = new URL(global.REPORT + "/RekapBeliHarianPTGLNonPajak.jasper");
                    InputStream in = url.openStream();
                    jasperPrint = JasperFillManager.fillReport(in, parameter, c);
                    JasperViewer.viewReport(jasperPrint, false);
                }
                ...
                parameter.put("Ptgl2", tgl2.getText());
                parameter.put("Psupplier", txtkodesupplier.getText());
                URL url = new URL(global.REPORT + "/RekapBeliHarianPTGLSupplier.jasper");
                InputStream in = url.openStream();
                jasperPrint = JasperFillManager.fillReport(in, parameter, c);
                JasperViewer.viewReport(jasperPrint, false);
                ...
                parameter.put("Ptgl1", tgl1.getText());
                parameter.put("Ptgl2", tgl2.getText());
                URL url = new URL(global.REPORT + "/RekapBeliHarianPTGL.jasper");
                InputStream in = url.openStream();
                jasperPrint = JasperFillManager.fillReport(in, parameter, c);
                JasperViewer.viewReport(jasperPrint, false);
            }
