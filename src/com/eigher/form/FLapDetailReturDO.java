 ...
 * @author eigher
 */
public class FLapDetailReturDO extends javax.swing.JInternalFrame {
    ...
    public FLapDetailReturDO() {
        ...
        try {
            ...
            Logger.getLogger(FLapDetailReturDO.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(javariesoft.JavarieSoftApp.class).getContext().getResourceMap(FLapDetailReturDO.class);
    ...
    private void btnPreviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPreviewActionPerformed
        ...
        try {
            ...
            URL url = new URL(global.REPORT + "/LapDetailReturDO.jasper");
