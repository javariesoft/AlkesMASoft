 ...
 * @author eigher
 */
public class FLapDetailPiutang extends javax.swing.JInternalFrame {
    ...
    public FLapDetailPiutang() {
        ...
        try {
            ...
            Logger.getLogger(FLapDetailPiutang.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(javariesoft.JavarieSoftApp.class).getContext().getResourceMap(FLapDetailPiutang.class);
        ...
        jScrollPane1.setBounds(40, 130, 500, 110);
        ...
        btnKeluar.setBounds(370, 190, 150, 40);
        ...
        btnPreview.setBounds(50, 190, 140, 40);
        ...
        LblFilter.setBounds(20, 14, 120, 16);
        ...
        btnClear.setBounds(200, 190, 160, 40);

        jSeparator1.setName("jSeparator1"); // NOI18N
        getContentPane().add(jSeparator1);
        jSeparator1.setBounds(20, 40, 520, 10);

        setBounds(0, 0, 578, 279);
    ...
    private void btnPreviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPreviewActionPerformed
        ...
        try {
            ...
            if (OptTanggal.isSelected() && OptStatus.isSelected() && OptPelanggan.isSelected()) {
                ...
                double totpiutang=piutangDao.getJumlahPiutangTglStatusPelanggan(c, tgl1.getText(), tgl2.getText() , stat, txtkodePelanggan.getText());
                ...
                parameter.put("TotPiutang", totpiutang);
                URL url = new URL(global.REPORT + "/LapAnalisaPiutangDetailPTglStatusPelanggan.jasper");
                ...
                parameter.put("Ptgl2", tgl2.getText());
                parameter.put("PStatus", stat);
                URL url = new URL(global.REPORT + "/LapAnalisaPiutangPTglStatus.jasper");
                InputStream in = url.openStream();
                jasperPrint = JasperFillManager.fillReport(in, parameter, c);
                JasperViewer.viewReport(jasperPrint, false);
                ...
                parameter.put("Ptgl2", tgl2.getText());
                parameter.put("PPelanggan", txtkodePelanggan.getText());
                URL url = new URL(global.REPORT + "/LapAnalisaPiutangPTglPelanggan.jasper");
                InputStream in = url.openStream();
                jasperPrint = JasperFillManager.fillReport(in, parameter, c);
                JasperViewer.viewReport(jasperPrint, false);
                ...
                parameter.put("Ptgl1", tgl1.getText());
                parameter.put("Ptgl2", tgl2.getText());
                URL url = new URL(global.REPORT + "/LapAnalisaPiutangPTgl.jasper");
                InputStream in = url.openStream();
                jasperPrint = JasperFillManager.fillReport(in, parameter, c);
                JasperViewer.viewReport(jasperPrint, false);
            }
