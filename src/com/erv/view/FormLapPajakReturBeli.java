 ...
 * @author USER
 */
public class FormLapPajakReturBeli extends javax.swing.JInternalFrame {

    /**
     * Creates new form FormLaporanPajak
     */
    Connection con;
    LapPajakReturBeliController controller;
    public FormLapPajakReturBeli() {
        try {
            koneksi.createPoolKoneksi();
            con = koneksi.getKoneksiJ();
            initComponents();
            controller = new LapPajakReturBeliController(con, this);
        } catch (SQLException ex) {
            Logger.getLogger(FormLapPajakReturBeli.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        setTitle("Laporan Pajak Retur Pembelian");
    ...
    try {
        ...
        if (cboJenis.getSelectedIndex()==0) {
            url = new URL(global.REPORT + "/PajakReturPembelianNonPKP.jasper");
            in = url.openStream();
            jasperPrint = JasperFillManager.fillReport(in, parameter, c);
        } else {
            url = new URL(global.REPORT + "/PajakReturPembelianPKP.jasper");
            in = url.openStream();
            jasperPrint = JasperFillManager.fillReport(in, parameter, c);
        }
