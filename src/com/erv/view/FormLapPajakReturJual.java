...
import com.erv.controller.LapPajakReturBeliController;
import com.erv.controller.LapPajakReturJualController;
 ...
 * @author USER
 */
public class FormLapPajakReturJual extends javax.swing.JInternalFrame {

    /**
     * Creates new form FormLaporanPajak
     */
    Connection con;
    LapPajakReturJualController controller;
    public FormLapPajakReturJual() {
        try {
            koneksi.createPoolKoneksi();
            con = koneksi.getKoneksiJ();
            initComponents();
            controller = new LapPajakReturJualController(con, this);
        } catch (SQLException ex) {
            Logger.getLogger(FormLapPajakReturJual.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        setTitle("Laporan Pajak Retur Penjualan");
    ...
    try {
        ...
        if (cboJenis.getSelectedIndex()==0) {
            url = new URL(global.REPORT + "/PajakReturPenjualanNonPKP.jasper");
            in = url.openStream();
            jasperPrint = JasperFillManager.fillReport(in, parameter, c);
        } else {
            url = new URL(global.REPORT + "/PajakReturPenjualanPKP.jasper");
            in = url.openStream();
            jasperPrint = JasperFillManager.fillReport(in, parameter, c);
        }
